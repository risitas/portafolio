const translations = {
    es: {
        ...
        serv_0_desc: "Soluciones integrales para tus necesidades de información.",
        serv_1_title: "Transcripción",
        serv_1_desc: "Audio y video a texto con alta precisión.",
        serv_2_title: "Escaneo a Texto",
        serv_2_desc: "Documentos escaneados o fotos a texto editable.",
        serv_3_title: "Transcripción de Imágenes",
        serv_3_desc: "Extracción de texto de imágenes.",
        serv_4_title: "Entrada de Datos",
        serv_4_desc: "Gestión de hojas de cálculo y tareas de copiar-pegar.",
        serv_5_title: "Limpieza de Texto",
        serv_5_desc: "Corrección, formato y organización.",
        serv_6_title: "Entrega Flexible",
        serv_6_desc: "Formatos Word, PDF o Texto Plano.",
        serv_7_title: "Eliminación de Muletillas",
        serv_7_desc: "Limpieza opcional de patrones de habla.",
        serv_8_title: "Subtítulos (.SRT)",
        serv_8_desc: "Archivos de subtítulos sincronizados para video.",
        serv_9_title: "Asistente Virtual",
        serv_9_desc: "Tareas diarias simples y organización.",
        samples_title: "Muestras de Trabajo",
        samples_desc: "Ejemplos de mi trabajo de conversión.",
        sample_1_title: "1. Transcripción de Audio",
        sample_1_desc: "Entrevista corta con etiquetas de hablantes.",
        sample_1_before: "Archivo de Audio",
        sample_1_p1: "<strong>Entrevistador:</strong> ¿Puedes explicar el proceso?",
        sample_1_p2: "<strong>Experto:</strong> Comienza con el análisis de datos brutos.",
        sample_2_title: "2. Video con Marcas de Tiempo",
        sample_2_desc: "Transcripción estilo YouTube.",
        ...
        sample_4_desc: "Info de PDF a tabla de hoja de cálculo.",
        sample_4_before: "Lista PDF:<br>- Item A (Stock: 5)<br>- Item B (Stock: 2)",
        sample_4_th1: "Item",
        sample_4_th2: "Stock",
        sample_5_title: "5. Subtítulos (.SRT)",
        sample_5_desc: "Archivo de subtítulos sincronizado.",
        ...
        sample_6_desc: "Eliminación de muletillas y formato.",
        sample_6_before: "O sea, em, tipo, el plan es... destinado a representar, ¿sabes?",
        sample_6_p1: "El plan está destinado a representar la idea central.",
        whyme_title: "Por Qué Elegirme",
        whyme_1_title: "Alta Precisión",
        whyme_1_desc: "Atención al detalle y precisión.",
        whyme_2_title: "Comunicación Amable",
        whyme_2_desc: "Comunicación rápida y clara.",
        ...
        whyme_4_desc: "Salida limpia y fácil de leer.",
        whyme_5_title: "Profesional",
        whyme_5_desc: "Un socio confiable para tu trabajo.",
        contact_title: "Trabajemos Juntos",
        contact_desc: "Envíame un mensaje para discutir tu próximo proyecto.",
